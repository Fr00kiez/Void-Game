...
public class attackWizardController implements Initializable {
    ...
    public void attackButtonOnAction(ActionEvent event) throws IOException{
        //memberikan damage ke musuh dan menampilkan damage lewat label wizardTalks
    }

    @FXML
    public void guardButtonOnAction(ActionEvent event) throws IOException{
        //bertahan dan menampilkan "Tidak ada serangan" pada wizardTalks dan damage yang didapat pada label playerTalks
    }

    @FXML
    public void lanjutButtonOnAction(ActionEvent event) throws IOException{
        //gak bisa lanjut kalau goblin belum mati, muncul warning. kalau sudah pindah ke endingScene.fxml
    }
